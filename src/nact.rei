...
type statefulActor('state, 'incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing) = 
    ('state, 'incoming, ctx('incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing)) => 'state;
...
type persistentActor('state, 'incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing) = 
    ('state, 'incoming, persistentCtx('incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing)) => 'state;
    
let spawn: (~name:string=?, actorRef('parentIncoming, 'parentOutgoing), statefulActor('state, 'incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing)) => actorRef('incoming, 'outgoing);        
let spawnStateless : (~name:string=?, actorRef('parentIncoming, 'parentOutgoing), statelessActor('incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing)) => actorRef('incoming, 'outgoing);       
let spawnPersistent : (~key:string, ~name:string=?, actorRef('parentIncoming, 'parentOutgoing), persistentActor('state, 'incoming, 'outgoing, 'parentIncoming, 'parentOutgoing, 'senderOutgoing)) => actorRef('incoming, 'outgoing);       
