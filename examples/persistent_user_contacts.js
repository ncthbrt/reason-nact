...
function createContactsService(parent, userId) {
  return Nact.spawnPersistent("contacts" + userId, /* Some */[userId], /* Some */[Caml_int32.imul(15, Nact.minutes)], /* Some */[Caml_int32.imul(10, Nact.messages)], /* None */0, parent, (function (state, param, param$1) {
                var msg = param[1];
                var sender = param[0];
