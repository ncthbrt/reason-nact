...
var ping = Nact.spawnStateless(/* Some */["ping"], /* None */0, /* None */0, /* None */0, system, (function (param, ctx) {
        console.log(param[1]);
...
var pong = Nact.spawnStateless(/* Some */["pong"], /* None */0, /* None */0, /* None */0, system, (function (param, ctx) {
        console.log(param[1]);
        return Promise.resolve(Nact.Operators[/* <-< */0](param[0], /* Msg */[
                        ctx[/* self */2],
                        ctx[/* name */4]
